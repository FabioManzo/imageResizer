...
class FileCacheManagerTest extends TestCase
{
    ...
    public function testGetCacheMissAndHit()
    {
        ...
        $pathGeneratedFromCallback = $fileManager->get($sourcePath, $mockCallable);
        ...
        $cachedPathVal = $fileManager->get($sourcePath, $mockCallable);
    ...
    public function testGetCacheRegenerationOnCacheExpiry()
    {
        ...
        $fileManager->get($sourcePath, $mockCallable);
